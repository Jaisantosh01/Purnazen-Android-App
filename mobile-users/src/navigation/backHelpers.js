 ...
 *
 * Copied from mobile-admin — port to users & doctors so tapping Home / Profile
 * always returns to the tab root instead of leaving the user mid-flow.
 */
