 ...
 *
 * Replaces the dated native `Alert.alert` popup with a themed, rounded card that
 * matches AppDialog. Mounted once in App.tsx; driven entirely by the alert store
 * so any module can trigger it imperatively without prop drilling.
 */
