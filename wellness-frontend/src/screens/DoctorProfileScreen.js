...
const styles = StyleSheet.create({
  ...
  tagIcon: { fontSize: 13 },
  tagText: { fontSize: 12, color: '#1FA77A', fontWeight: '500' },
  ...
  educationExp: { fontSize: 12, color: '#9ca3af' },
  ...
  awardBorder: { borderBottomWidth: 1, borderBottomColor: '#f3f4f6' },
  awardIcon: { fontSize: 18 },
  awardText: { fontSize: 14, fontWeight: '500', color: '#1a1a1a' },
  ...
  feeAmount: { fontSize: 20, fontWeight: '700', color: '#1FA77A' },
  bookBtn: {
    backgroundColor: '#1FA77A',
    borderRadius: 14,
    paddingVertical: 14,
