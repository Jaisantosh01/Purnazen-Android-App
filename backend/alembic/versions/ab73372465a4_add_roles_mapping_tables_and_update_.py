...
def upgrade():
    ...
    # Data migration: Create roles from existing user roles
    ...
    op.add_column('consultation_types', sa.Column('updated_at', sa.DateTime(), nullable=True))
    ...
    # Data migration: Link users to their roles
